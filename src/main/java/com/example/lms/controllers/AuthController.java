...
public class AuthController {
    ...
    @PostMapping("/login")
    BaseResponse<AuthenticationResponse> login(@RequestBody AuthenticationRequest request) {
        return BaseResponse.of("Login successful", authenticationService.login(request));
    }
}
